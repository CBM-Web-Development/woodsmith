	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light primary-navbar">
		...
		<div class="container-fluid">
			...
			$left_navigation_args = array(
				...
				'menu_id'			=> '', 
				'container'			=> 'div', 
				'container_class'	=> 'collapse navbar-collapse justify-content-lg-end order-lg-0 navbar-primary-left',
			...
			$right_navigation_args = array(
				...
				'menu_id'			=> '', 
				'container'			=> 'div', 
				'container_class'	=> 'collapse navbar-collapse justify-content-lg-start order-lg-3 navbar-primary-right',
